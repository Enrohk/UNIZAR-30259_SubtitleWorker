...
public class StarRater extends JPanel {
     ...
     * The constructor.
     */
    public StarRater(boolean enabled) {
        this(5, enabled);
    }
     ...
     */
    public StarRater(int stars, boolean enabled) {
        this(stars, 0, enabled);
    }
     ...
     */
    public StarRater(int stars, float rating, boolean enabled) {
        this(stars, rating, 0, enabled);
    }
     ...
     */
    public StarRater(int stars, float rating, int selection, boolean enabled) {
        this.stars = stars;
        this.rating = rating;
